...
import { IUserGraphqlService } from '../../interfaces/services/user/user-graphql/user-graphql.interface';
import {
  IUserGraphqlServiceRegisterUserParams,
  IUserGraphqlServiceRegisterUserResult,
} from '../../interfaces/services/user/user-graphql/methods/register-user.interface';
import {
  IUserGraphqlServiceGetUserParams,
  IUserGraphqlServiceGetUserResult,
} from '../../interfaces/services/user/user-graphql/methods/get-user.interface';
import {
  IUserGraphqlServiceSearchUsersParams,
  IUserGraphqlServiceSearchUsersResult,
} from '../../interfaces/services/user/user-graphql/methods/search-users.interface';
import {
  IUserGraphqlServiceModifyUserParams,
  IUserGraphqlServiceModifyUserResult,
} from '../../interfaces/services/user/user-graphql/methods/modify-user.interface';
import {
  IUserGraphqlServiceDeleteUserParams,
  IUserGraphqlServiceDeleteUserResult,
} from '../../interfaces/services/user/user-graphql/methods/delete-user.interface';
