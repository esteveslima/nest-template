...
import { IMediaRestServiceSearchMediasParams } from 'src/modules/apps/media/application/interfaces/services/media-rest/methods/search-medias.interface';
import { MediaValidatorDTO } from './base/media-validator.dto';

// search filters
export class SearchMediasReqDTO
  extends PartialType(
