...
import { IMediaRestServiceGetMediaParams } from 'src/application/interfaces/services/media/media-rest/methods/get-media.interface';
import { MediaValidatorDTO } from './base/media-validator.dto';

export class GetMediaRestRequestDTO
