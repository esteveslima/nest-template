...
// authenticated user found after jwt validation on the request object It applies the custom pipe on the result value from the param decorator(IAuthData), to finally result in the pipe's result for the decorator(UserEntity)

import { createParamDecorator, ExecutionContext } from '@nestjs/common';
import { GetAuthUserPipe } from '../../enhancers/pipes/get-auth-user.pipe';
